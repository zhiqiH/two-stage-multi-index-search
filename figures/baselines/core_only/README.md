...
This historical core-only directory was generated from exported baseline CSV files. It does not rerun retrieval and does not read gold data beyond exported evaluation metrics.
...
- `by_metric/`: one chart per metric comparing the three final baselines.
...
- Formal baselines: `dense`, `file_fts`, `graph_path`.
