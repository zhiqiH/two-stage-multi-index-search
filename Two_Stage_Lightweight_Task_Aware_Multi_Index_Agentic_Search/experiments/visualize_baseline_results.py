...
def write_readme(out_dir: Path, generated: list[Path]) -> None:
    ...
    lines = [
        ...
        "",
        "本目录基于 `baseline_result` 中的真实 CSV 指标生成，不重新运行检索，也不读取 gold 以外的新信息。",
        "",
...
def write_readme(out_dir: Path, generated: list[Path]) -> None:
    ...
    lines = [
        "# Baseline Visualization Index",
        "",
        "This directory is generated from `baseline_result` CSV files. It does not rerun retrieval and does not read gold data beyond exported evaluation metrics.",
        "",
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--baseline-dir",
        default=r"D:\mark_ai_project\projects\project\baseline_result",
        help="Directory containing baseline_metrics_*.csv and failure_cases_k5.csv.",
    )
    parser.add_argument(
        "--out-dir",
        default=r"D:\mark_ai_project\projects\project\baseline_result\visualization",
