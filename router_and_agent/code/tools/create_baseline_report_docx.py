...
def create_report(
    *,
    ...
    dashboard = baseline_dir / "visualization_fusion_oracle" / "summary" / "baseline_evaluation_dashboard.png"
    if dashboard.exists():
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--baseline-dir", default=r"D:\mark_ai_project\projects\project\baseline_result")
    parser.add_argument("--results-dir", default="results/final")
    parser.add_argument(
        "--out",
        default=r"D:\mark_ai_project\projects\project\baseline_result\冻结基线实验设计与结果分析报告.docx",
    )
    return parser
